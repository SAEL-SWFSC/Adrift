...
```
```{r, ADRIFT deployExport1, include=FALSE}
...
DeployTable_ADRIFT_ex <- deployDetails %>%
  gt()%>%
...
DeployTable_ADRIFT_ex  
gtsave(DeployTable_ADRIFT_ex, filename = here("output", "DeployTable_ADRIFT.html"))
...
```{r, Complete Deployment Table ADRIFT}
# Make Expanded Table for Appendix
DeployTable_Adrift <- deployDetails %>% 
  gt()%>%

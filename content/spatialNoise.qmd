...
-   Evaluate depth-dependent changes in ambient
    noise levels. Sound levels recorded by drifting recorders can be compared with
    bottom-moored sensors to measure depth dependent changes in ambient noise
    levels. This is particularly relevant if future acoustic monitoring is limited
    to seafloor sensors, which do not occupy the predominant habitat of most marine
    mammals, or sensors that modulate their depth throughout the survey period
    (e.g., gliders).

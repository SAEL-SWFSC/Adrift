...
There were few acoustic detections of humpback whales during the late June/early July surveys off Morro Bay (@fig-AdPC_humpback_HourlyPresence). 

:::

::: {.column width="60%"}

```{r humpTbl, child= "../R/detTbls/humpTbl.Rmd"}

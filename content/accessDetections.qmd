...
late September/early October @fig-ACCESS_Pm_HourlyPresence. Most sperm
...
in all regions except Morro Bay (@tbl-pm).
...
|--------------------|:----------:|:--------------:|:------:|
| **Regular Clicks** | 0.03 (769) |   0.00 (626)   |   --   |
| **Slow Clicks**    | 0.01 (769) |   0.00 (626)   |   --   |

: Summary of sperm whale detections for regular and slow clicks in
hourly bins for Adrift-ACCESS surveys. Mean hourly probability of sperm
whale detection for that call type/season; total hourly bins are shown
in parenthesis. {#tbl-pm}
...
oceanographic
season.](/figs/ACCESS/ACCESS_Pm_HourlyPresence.png){#fig-ACCESS_Pm_HourlyPresence width="400"}
...
recordings collected during the Adrift-ACCESS surveys (@tbl-bw,
@fig-ACCESS_ZcBb_HourlyPresence). Detections of both species were higher
during the post-upwelling season, and goose-beaked whales were more
commonly detected than Baird’s beaked whales (@tbl-bw).

|                          |  Upwelling   | Post-Upwelling | Winter |
|--------------------------|:------------:|:--------------:|:------:|
| **Baird's beaked whale** | 0.0031 (960) |  0.0176 (688)  |   --   |
| **Goose-beaked whale**   | 0.0147 (960) |  0.0250 (688)  |   --   |

: Summary of beaked whale detections Baird’s beaked whales and
goose-beaked whales in hourly bins for Adrift-ACCESS data. Summary of
beaked whale detections for Baird’s beaked whales and goose-beaked
whales in hourly bins for Adrift-ACCESS data. Mean hourly probability of
detection for that species/season; total hourly bins are shown in
parenthesis. {#tbl-bw}

![Hourly goose-beaked whales and Baird's beaked whales by month for the
Adrift-ACCESS surveys. Hourly presence of goose-beaked whales (left) and
Baird's beaked whales (right) (y axis) for different months for combined
years (x axis) during the Adrift-ACCESS surveys. Hourly presence for
duty-cycled data relates to the portion of the hour included in the duty
cycled data. Black lines represent total available hours (effort) and
red lines represent hours with detections. Blue shading represents
winter, green represents upwelling, and yellow represents the
post-upwelling oceanographic
season.](/figs/ACCESS/ACCESS_ZcBb_HourlyPresence.png){#fig-ACCESS_ZcBb_HourlyPresence}
...
Farallones and Cordell Bank National Marine Sanctuaries. The discrepancy
in these detections is likely due to the typically poor sighting
conditions in this region and the cryptic surfacing behavior of beaked
whales. Future surveys in this region should consider passive acoustic
monitoring with sufficient bandwidth to detect echolocating beaked
whales.

### **Dolphins**

Dolphins were detected during all Adrift-ACCESS deployments
(@fig-ACCESS_GgLo_HourlyPresence). Dolphin events included detections that
could be positively attributed to Risso's dolphins and Pacific
white-sided Dolphins, and detections that remained unidentified
(@tbl-dolphin).

|                                  | Upwelling  | Post-Upwelling | Winter |
|----------------------------------|:----------:|:--------------:|:------:|
| **Risso's dolphins**             | 0.01 (960) |   0.01 (688)   |   --   |
| **Pacific white-sided dolphins** | 0.10 (960) |   0.23 (688)   |   --   |
| **Unidentified dolphins**        | 0.00 (960) |   0.00 (688    |   --   |

: Summary of dolphin detections (by species) in hourly bins for
Adrift-ACCESS data. Summary of dolphin detections for Risso’s dolphins,
Pacific white-sided dolphins, and unidentified odontocetes for hourly
bins for Adrift-ACCESS data. Mean hourly probability of detection for
that species/season; total hourly bins are shown in parenthesis.
{#tbl-dolphin}

There were no dolphin events that did not include at least Risso’s or
Pacific white-sided dolphins (@tbl-dolphin). Pacific white-sided
dolphins were detected at higher rates than Risso’s dolphins in all but
the earliest survey during the upwelling season
@fig-ACCESS_GgLo_HourlyPresence. Dolphin schools in central and northern
California are frequently encountered in large, dispersed mixed species
groups (S.Rankin, pers. comm.), and here we do not distinguish mixed
species from single-species groups. So, attribution of an acoustic event
to Risso's dolphins does not preclude the presence of other species. We
currently lack a comprehensive acoustic classification routine that
includes all dolphin schools in the region. Future research should
develop a publicly available acoustic classifier for dolphins that
considers mixed species groups and can be applied to different passive
acoustic platforms.
...
season.](/figs/ACCESS/ACCESS_GgLo_HourlyPresence.png){#fig-ACCESS_GgLo_HourlyPresence}
...
(June, @fig-ACCESS_NBHF_HourlyPresence) and the hourly probability of
detection was higher for the post-upwelling season than for the
upwelling season (@tbl-nbhf).

|                   | Upwelling  | Post-Upwelling | Winter |
|-------------------|:----------:|:--------------:|:------:|
| **San Francisco** | 0.05 (960) |   0.27 (688)   |   --   |

: Summary of NBHF detections in hourly bins for Adrift-ACCESS data.
Summary of NBHF detections for Adrift-ACCESS data. Mean hourly
probability of NBHF detection for that season; total hourly bins are
shown in parenthesis. {#tbl-nbhf}
...
shading represents winter, green represents upwelling, and yellow
represents the post-upwelling oceanographic
season.](/figs/ACCESS/ACCESS_NBHF_HourlyPresence.png){#fig-ACCESS_NBHF_HourlyPresence
width="400"}
...
upwelling deployment @fig-ACCESS_Bm_HourlyPresence, with most detections
during the post-upwelling season (@tbl-blue).

|             | Upwelling  | Post-Upwelling | Winter |
|-------------|:----------:|:--------------:|:------:|
| **A Calls** | 0.00 (960) |   0.31 (688)   |   --   |
| **B Calls** | 0.02 (960) |   0.50 (688)   |   --   |
| **D Calls** | 0.03 (960) |   0.06 (688)   |   --   |

: Summary of blue whale detections in hourly bins for Adrift-ACCESS
data. Summary of blue whale detections for A, B, and D calls in hourly
bins for Adrift-ACCESS data. Mean hourly probability of blue whale
detection for that call type/season; total hourly bins are shown in
parenthesis. {#tbl-blue}
...
season.](/figs/ACCESS/ACCESS_Bm_HourlyPresence.png){#fig-ACCESS_Bm_HourlyPresence
width="400"}
...
@fig-ACCESS_BmD_HourlyPresence. Blue whale ‘song’ consists of both A and B
...
(@tbl-blue). There were only a few blue whale B calls detected during
the upwelling season off San Francisco. The probability of detecting
blue whale B calls was consistently higher than A calls, which reflects
...
(late upwelling/early post-upwelling, @fig-ACCESS_BmD_HourlyPresence). The
...
![Hourly presence of blue whale D calls by month for the Adrift-ACCESS
surveys. Hourly presence of blue whale D calls (y axis) for different
months for combined years (x axis) during the Adrift-ACCESS surveys.
Adrifts 001-012 were duty cycled and hourly presence relates to the
portion of the hour included in the duty cycled data (6 min of 12 min).
Black lines represent total available hours (effort) and red lines
represent hours with detections. Blue shading represents winter, green
represents upwelling, and yellow represents the post-upwelling
oceanographic
season.](/figs/ACCESS/ACCESS_BmD_HourlyPresence.png){#fig-ACCESS_BmD_HourlyPresence
width="400"}
...
post-upwelling deployments (@tbl-fin, @fig-ACCESS_fin20_HourlyPresence).
There were no detection of fin whale 40 Hz calls during the
Adrift-ACCESS deployments (@tbl-fin).

|           | Upwelling  | Post-Upwelling | Winter |
|-----------|:----------:|:--------------:|:------:|
| **20 Hz** | 0.04 (960) |   0.12 (688)   |   --   |
| **40 Hz** | 0.00 (960) |   0.00 (688)   |   --   |

: Summary of fin whale detections in hourly bins for Adrift-ACCESS data.
Summary of fin whale 20 Hz and 40 Hz detections in hourly bins for
Adrift-ACCESS data. Mean hourly probability of fin whale detection for
...
fin whale 40 Hz calls in this region (@tbl-fin).
...
shading represents winter, green represents upwelling, and yellow
represents the post-upwelling oceanographic
season.](/figs/ACCESS/ACCESS_fin20_HourlyPresence.png){#fig-ACCESS_fin20_HourlyPresence
width="400"}
...
(@fig-ACCESS_humpback_HourlyPresence), with higher probability of detection
in the post-upwelling season off San Francisco (@tbl-hump). Hourly
probability of detecting song was higher in the post-upwelling than the
upwelling season (@tbl-hump).

|                  |   Upwelling   | Post-Upwelling | Winter |
|------------------|:-------------:|:--------------:|:------:|
| **Song**         |  0.03 (960)   |   0.36 (688)   |   --   |
| **Social Calls** | 0.01 (960)    |   0.24 (688)   |   --   |
| **Undetermined** |  0.06 (960)   |   0.28 (688)   |   --   |

: Summary of humpback whale detections in hourly bins for Adrift-ACCESS
data. Summary of humpback whale detections for Song, Social sounds, and
Unidentified calls in hourly bins for Adrift-ACCESS data. Mean hourly
probability of humpback whale detection for that call
type/region/season; total hourly bins are shown in parenthesis.
{#tbl-hump}
...
represents the post-upwelling oceanographic
season.](/figs/ACCESS/ACCESS_humpback_HourlyPresence.png){#fig-ACCESS_humpback_HourlyPresence
width="400"}
...
dominated the recordings (@fig-ACCESS_humpbackSongSocial_HourlyPresence).
...
with detections. Blue shading represents winter, green represents
upwelling, and yellow represents the post-upwelling oceanographic
season.](/figs/ACCESS/ACCESS_humpbackSongSocial_HourlyPresence.png){#fig-ACCESS_humpbackSongSocial_HourlyPresence}
...
(@tbl-gray, @fig-ACCESS_gray_HourlyPresence). There is a significant overlap
...
: Summary of gray whale detections in hourly bins for Adrift-ACCESS
data. Summary of gray whale detections for Adrift-ACCESS data. Mean
hourly probability of gray whale detection for that region/season; total
hourly bins are shown in parenthesis. {#tbl-gray}
...
shading represents winter, green represents upwelling, and yellow
represents the post-upwelling oceanographic
season.](/figs/ACCESS/ACCESS_gray_HourlyPresence.png){#fig-ACCESS_gray_HourlyPresence
width="400"}

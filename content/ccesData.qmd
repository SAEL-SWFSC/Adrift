...
A complete list of successful drifting recorder deployments during the CCES survey are provided in the table (below). Sites include Humboldt (HUM), Point Arena (PTA), Morro Bay (MOB), Channel Islands (CHI), and Baja California Norte (BCN). See [Study Area Figure 1](https://sael-swfsc.github.io/Adrift/content/studyArea.html) for more information on regions.
